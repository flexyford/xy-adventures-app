...
define('xy-adventures-app/templates/components/hero-wrapper', ['exports', 'ember'], function (exports, Ember) {
  ...
  function program5(depth0,data) {
    ...
    data.buffer.push("> \n     X Y Adventures </h1>\n    <img src=\"assets/images/xy_nav_clear_diamond.png\" ");
    data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
      'class': (":hero-logo")
    },hashTypes:{'class': "STRING"},hashContexts:{'class': depth0},contexts:[],types:[],data:data})));
    data.buffer.push("/>\n    <h3 ");
...
define('xy-adventures-app/templates/components/map-container', ['exports', 'ember'], function (exports, Ember) {
  ...
  helpers = this.merge(helpers, Ember['default'].Handlebars.helpers); data = data || {};
    ...
    data.buffer.push("\n    <button class=\"button small float-left\" id=\"submit-button\" type=\"submit\" ");
...
define('xy-adventures-app/tests/components/map-container.jshint', function () {
  ...
  test('components/map-container.js should pass jshint', function() { 
    ok(false, 'components/map-container.js should pass jshint.\ncomponents/map-container.js: line 21, col 25, Missing semicolon.\ncomponents/map-container.js: line 60, col 56, Missing semicolon.\ncomponents/map-container.js: line 70, col 15, Missing semicolon.\ncomponents/map-container.js: line 144, col 78, Missing semicolon.\ncomponents/map-container.js: line 86, col 9, \'map\' is defined but never used.\ncomponents/map-container.js: line 85, col 31, \'geojson\' is defined but never used.\n\n6 errors'); 
  });
...
if (runningTests) {
  ...
  require("xy-adventures-app/app")["default"].create({"name":"xy-adventures-app","version":"0.0.0.b50788cb"});
}
